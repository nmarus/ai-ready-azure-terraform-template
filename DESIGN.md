...
This document is the authoritative design reference for this repository. [`AGENTS.md`](AGENTS.md) references this document and provides AI-agent-optimized summaries for code generation.
